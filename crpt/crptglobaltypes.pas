...
type
  ...
  TDocumentDirection = (ddAll, ddInput, ddOutput);
  ...
  TDocumentType = (
    ...
    LP_SHIP_RECEIPT, LP_SHIP_RECEIPT_CSV, CSVLP_SHIP_RECEIPT_XML, LP_SHIP_GOODS_CROSSBORDER,
    ...
    LK_KM_CANCELLATION, LK_KM_CANCELLATION_XML, LK_KM_CANCELLATION_CSV,
    LK_APPLIED_KM_CANCELLATION, LK_APPLIED_KM_CANCELLATION_XML, LK_APPLIED_KM_CANCELLATION_CSV,
    ...
    LP_FTS_INTRODUCE_JSON, LP_FTS_INTRODUCE_XML, LP_FTS_INTRODUCE_CSV,
  ...
  TCISStatus = (CISStatusError = -1, EMITTED, APPLIED, INTRODUCED, WRITTEN_OFF, RETIRED, RESERVED_NOT_USED,
    INTRODUCED_RETURNED, DISAGGREGATED, WAIT_SHIPMENT, EXPORTED, LOAN_RETIRED,
    REMARK_RETIRED, APPLIED_NOT_PAID, FTS_RESPOND_NOT_OK, FTS_RESPOND_WAITING, FTS_CONTROL);

  TDocStatus = (UNDEFINED, IN_PROGRESS, CHECKED_OK, CHECKED_NOT_OK, PROCESSING_ERROR,
    CANCELLED, WAIT_ACCEPTANCE, WAIT_PARTICIPANT_REGISTRATION, WAIT_FOR_CONTINUATION,
    ACCEPTED);
...
type
  TCrptDocListFilter = record
    ...
    DocumentStatus:TDocStatus;
    ParticipantInn:string;
    DocumentDirection:TDocumentDirection;
  end;
...
const
  DocStatusStr : array [TDocStatus] of string = (
    'UNDEFINED',
    'IN_PROGRESS',
    'CHECKED_OK',
    'CHECKED_NOT_OK',
  ...
  DocumentTypeStr : array [TDocumentType] of string = (
