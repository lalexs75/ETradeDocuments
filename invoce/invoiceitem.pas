...
begin
  ...
  RegisterProperty('Vat', 'СумНалВсего', 'О', 'Всего к оплате, Сумма налога, предъявляемая покупателю (строка "Всего к оплате"/графа 8 счета-фактуры)', -1, -1);
  RegisterProperty('TotalNet', 'КолНеттоВс', 'Н', 'Количество (масса нетто/количество) - всего по документу', 1, 26);
end;
